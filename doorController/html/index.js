...
$(document).ready(function() {
  $.get('/local/camscripter/package/settings.cgi?package_name=doorController&action=get', function(settings) {
    ...
    if (Object.keys(settings).length == 0) {
      settings = {"camera_user": "root", "camera_pass": "", "camera_ip": "127.0.0.1", "controller_host": "", "controller_port": 80, "controller_user": "root", "controller_pass": "", "pos_x": 0, "pos_y": 0, "width": 1920, "height": 1080, "scale": 1.0};
    }
