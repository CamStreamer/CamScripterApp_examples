            ...
            <Controller
                ...
                render={({ field, formState }) => (
                    <StyledTextField
                        ...
                        label="Start Time"
                        InputLabelProps={{ shrink: true }}
                        error={!!formState.errors.widget?.start_time}
                        helperText={formState.errors.widget?.start_time?.message}
                    />
                )}
            />
            ...
            <Controller
                ...
                render={({ field, formState }) => (
                    <StyledTextField
                        ...
                        label="Group name"
                        InputLabelProps={{ shrink: true }}
                        error={!!formState.errors.widget?.group_name}
                        helperText={formState.errors.widget?.group_name?.message}
                    />
                )}
            />
