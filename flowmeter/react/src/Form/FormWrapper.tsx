...
import { TSettingsSchema, settingsSchema } from '../models/schema';
...
export const FormWrapper = ({ defaultValues }: Props) => {
    ...
    const onSubmit: SubmitHandler<TSettingsSchema> = async (toPost) => {
    ...
    const onError: SubmitErrorHandler<TSettingsSchema> = (errors) => {
