...
import { TSettingsSchema /* serverDataSchema*/, settingsSchema } from './models/schema';
...
export const App = () => {
    ...
    const [defaultValues, setDefaultValues] = useState<TSettingsSchema | null>(null);

    useInitializeOnMount(async () => {
        let response: Response;
        let data: TSettingsSchema;
        try {
