...
$(document).ready(function () {
  $.get(
    "/local/camscripter/package/settings.cgi?package_name=tempPCSensor&action=get",
    function (settings) {
      ...
      $("input[name=u_select][value=" + settings.unit + "]").prop(
        "checked",
        true
      );
      unit = settings.unit;
...
function inputChanged() {
  ...
  $.post(
    "/local/camscripter/package/settings.cgi?package_name=tempPCSensor&action=set",
